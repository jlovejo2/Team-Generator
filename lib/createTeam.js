        ...
        this.htmlArr.then((val) => {
            ...
            const mapArr = that.team.map(function (index) {
                ...
                if (index.getRole() === "Manager") {
                    ...
                    htmlNew = htmlNew.replace(",", "");   // // console.log(htmlToAdd);
                    // return htmlToAdd
                } else {
                    console.log("intern")
            ...
            // if (numOfTeamMembers == 3) {
            //     teamHtml = val[3].replace("((((Team Members Go Here))))", mapArr.join());
            // } else if (numOfTeamMembers > 3) {
            //     let count = 0;
...
//          fs.readFileAsync('./templates/engineer.html', function (err, data) {
//              if (err) {
//                  throw err;
//              }
...
//          fs.readFile('./templates/manager.html', function (err, data) {
//              if (err) {
//                  throw err;
//              }
//              resolve(data.toString())
...
//          fs.readFile('./templates/intern.html', function (err, data) {
//              if (err) {
//                  throw err;
//              }
//              resolve(data.toString())
//          })
//      });
//      this.htmlArr = Promise.all([promise1, promise2, promise3, this.start2()]).then(function (html) {
//          return html;
//      })
//  }
...
// this.managerHTML = fs.readFile('./templates/manager.html', function (err, data) {
        //     if (err) {
        //         throw err;
        //     }
        //     return data.toString()
        // });
        // this.engineerHTML = fs.readFile('./templates/engineer.html', function (err, data) {
        //     if (err) {
        //         throw err;
        //     }
        //     return data.toString()
        // });
        // this.internHTML = fs.readFile('./templates/intern.html', function (err, data) {
        //     if (err) {
        //         throw err;
        //     }
        //     return data.toString()
